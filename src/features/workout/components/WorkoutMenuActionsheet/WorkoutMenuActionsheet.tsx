...
import type { WorkoutMenuActionsheetProps } from ".";
    ...
    <Actionsheet isOpen={isOpen} onClose={onClose}>
      ...
      <ActionsheetContent className="bg-background-primary dark:bg-dark-background-primary">
        ...
        <VStack className="w-full p-4" space="sm">
          <Text size="lg" bold className="text-text-headline dark:text-dark-text-headline px-2 pb-2">
            Opções do Treino
          </Text>
          ...
          <ActionsheetItem onPress={onDelete} className="py-4">
            <HStack space="md" className="items-center">
              ...
              <ActionsheetItemText className="text-red-500 dark:text-red-400 text-base">
                Deletar Treino
              </ActionsheetItemText>
            </HStack>
          </ActionsheetItem>
